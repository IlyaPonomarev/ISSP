...
Функция ДобавитьПечатнуюФорму(ПечатныеФормы) Экспорт
	...
	ПечатнаяФорма = УправлениеПечатьюПоддержкаПроектов.ДобавитьПечатнуюФорму(ПечатныеФормы, "НакладнаяНаВнутреннееПеремещение0504102", МенеджерПечати);
...
//
Функция ПечатьНакладнаяНаВнутреннееПеремещение0504102(МассивОбъектов, ОбъектыПечати) Экспорт
...
Процедура СформироватьТабличныйДокумент(ТабличныйДокумент, Макет, ДанныеДляПечати, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		ПроверитьВыводПодвала(ТабличныйДокумент, Макет, МассивВыводимыхОбластей);
		
		// Вывод области ОтметкаБухгалтерииШапка
		ФормированиеПечатныхФормПоддержкаПроектов.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "ОтметкаБухгалтерииШапка");
		
		// Вывод области ОтметкаБухгалтерииСтрока
		ФормированиеПечатныхФормПоддержкаПроектов.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "ОтметкаБухгалтерииСтрока", ПараметрыИтого);
		
		// Вывод области Исполнитель
		ФормированиеПечатныхФормПоддержкаПроектов.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "Исполнитель", ДанныеШапки);
...
Процедура ПроверитьВыводПодвала(ТабличныйДокумент, Макет, МассивВыводимыхОбластей)
	
	МассивВыводимыхОбластей.Очистить();
	МассивВыводимыхОбластей.Добавить(Макет.ПолучитьОбласть("ОтметкаБухгалтерииШапка"));
	МассивВыводимыхОбластей.Добавить(Макет.ПолучитьОбласть("ОтметкаБухгалтерииСтрока"));
	МассивВыводимыхОбластей.Добавить(Макет.ПолучитьОбласть("Исполнитель"));
...
Функция МетаданныеМакета()
	...
	Возврат Метаданные.Обработки.ПечатьНакладнаяНаВнутреннееПеремещение0504102.Макеты.ПФ_MXL_НакладнаяНаВнутреннееПеремещение0504102;
