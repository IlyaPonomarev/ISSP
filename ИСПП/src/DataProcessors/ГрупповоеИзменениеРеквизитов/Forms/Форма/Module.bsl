...
Процедура Изменить(Команда)
	...
	ПраваВыполнениеКода = ДоступныеПраваВыполнениеКода();
	
	Если Не ПраваВыполнениеКода.ДоступноВыполнениеКода Тогда
		Возврат;
	КонецЕсли;
	
	Если Объект.ТипОперации = "ВыполнитьАлгоритм"
		И Объект.РежимВыполнения = 1 
		И НЕ ПраваВыполнениеКода.ДоступноВыполнениеКодаВНебезопасномРежиме Тогда
