...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	|ИЗ
	|	РегистрНакопления.БракНаСкладах КАК Таблица
	|ГДЕ
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|ПОМЕСТИТЬ ДвиженияБракНаСкладахИзменение
	|ИЗ
	...
	Если Выборка.Количество > 0 Тогда
		ПроведениеПоддержкаПроектов.ДобавитьПараметрыКонтроля(
			...
			РегистрыНакопления.БракНаСкладах);
	КонецЕсли;
...
Функция ТекстЗапросаПроверки()
	...
	|					Таблица.Склад
	|				ИЗ
	|					ДвиженияБракНаСкладахИзменение КАК Таблица)
	|	) КАК ТаблицаОстатков
	|
	|ГДЕ
