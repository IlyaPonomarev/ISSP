...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	|ПОМЕСТИТЬ ТоварыНаСкладахПередЗаписью
	|ИЗ
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|ИЗ
	|	ТоварыНаСкладахПередЗаписью КАК Таблица
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|
	|//////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ТоварыНаСкладахПередЗаписью
	|;
	|
	|//////////////////////////////////////////////////////////////////////////////
	...
	// Новые изменения были помещены во временную таблицу "ДвиженияТоварыНаСкладахИзменение".
