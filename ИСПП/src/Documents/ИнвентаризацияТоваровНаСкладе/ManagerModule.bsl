...
Функция ДоступныеПечатныеФормы() Экспорт
	...
	ПечатнаяФорма = Обработки.ПечатьИнвентаризационнаяОпись.ДобавитьПечатнуюФорму(ПечатныеФормы);
	КомандаПечати = УправлениеПечатьюПоддержкаПроектов.ДобавитьКомандуПечати(ПечатнаяФорма);
	
	ПечатнаяФорма = Обработки.ПечатьИнвентаризационнаяОпись.ДобавитьПечатнуюФормуАктИнвентаризации(ПечатныеФормы);
	КомандаПечати = УправлениеПечатьюПоддержкаПроектов.ДобавитьКомандуПечати(ПечатнаяФорма);
...
Функция ТекстЗапросаДанныеДляПечати()
	...
	|		Партия КАК Партия,
	|		Партия.ДокументОприходования КАК ДокументОприходования,
	|		Партия.ДокументОприходования.ПроектЗадания КАК ПроектЗадания,
	|		Партия.ДокументОприходования.Контрагент КАК Контрагент,
	|		Партия.ДокументОприходования.Контрагент.НаименованиеПолное КАК КонтрагентНаименование,
	|		ВЫБОР
	...
	|	Документ.Гриф.ПолноеНаименование КАК Гриф
	|ИЗ
