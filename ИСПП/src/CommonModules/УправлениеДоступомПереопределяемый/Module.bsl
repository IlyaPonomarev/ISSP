...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	УправлениеДоступомПоддержкаПроектов.ПриЗаполненииВидовДоступа(ВидыДоступа);	
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// ПоддержкаПроектов
	УправлениеДоступомПоддержкаПроектов.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
