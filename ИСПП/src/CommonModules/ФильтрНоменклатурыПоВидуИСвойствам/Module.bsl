...
//
// Параметры:
//  Форма -УправляемаяФорма - форма, на которую добавляется фильтр.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, где устанавливаются начальные настройки.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, для которой сохраняются настройки.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, из которой получается страница фильтра.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, у которой обрабатывается фильтр.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, в которой обрабатывается отмена фильтра.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, где устанавливается доступность изменения элементов фильтра.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, где выключается использование фильтра.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, где сбрасываются все отборы выбранного фильтра.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, в которой устанавливаются настройки.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, в которой обрабатывается изменение изменение вида номенклатуры.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, в которой обрабатывается изменение отбора по свойству номенклатуры.
//
