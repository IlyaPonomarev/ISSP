...
Функция ПолучитьПараметрыОбработкиШтрихкодов(Штрихкоды, ДействияСДобавленнымиСтроками, ДействияСИзмененнымиСтроками) Экспорт
	...
	ПараметрыОбработкиШтрихкода.Вставить("Штрихкоды"                      , МассивШтрихкодов);
	...
	ПараметрыОбработкиШтрихкода.Вставить("ИспользоватьПартии"             , Истина);
	...
	Для Каждого СтрокаТовара Из Товары Цикл
		Если ЗначениеЗаполнено(СтрокаТовара.Штрихкод) Тогда
			ДанныеШтрихкодов.Добавить(
				ОбщегоНазначенияПоддержкаПроектовКлиентСервер.ПолучитьДанныеШтрихкода(СтрокаТовара.Штрихкод, СтрокаТовара.Количество));
		КонецЕсли;
	КонецЦикла;
