...
Процедура СгенерироватьОписаниеСписанияИзделий(ТаблицаНоменклатуры, ДатаОтчета)
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ДетализацияСписанияМСИПоТипамОбороты.АналитикаУчетаНоменклатуры.Номенклатура КАК Номенклатура,
		...
		|СГРУППИРОВАТЬ ПО
		|	ДетализацияСписанияМСИПоТипамОбороты.АналитикаУчетаНоменклатуры.Номенклатура,
